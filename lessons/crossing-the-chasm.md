...
3. Early majority: "I'll buy one when the **performance is proven** and there are **enough charging stations** on the roads."
4. Late majority: "I'll buy one when **many people** switch to electric vehicles and gasoline cars become really inconvenient."
5. Laggard: "**That will never happen.**"
...
- Google Glass needs to create a completely seamless experience, but the gap between that capability and willingness to pay is too large. Anyone can expect XR technology to advance, but the timeline to reach critical mass is too far in the future, so virtual reality only offers fantasies to enthusiasts.
- The early majority can acquire technical skills when necessary. The late majority cannot. To bridge the gap between these two groups, products need to be designed for easier consumer adoption.
...
- Who is it for (target customers - limited to the beachhead market segment)?
- Who is dissatisfied with (existing market alternatives)?
- Our product is a (product category).
- Our product provides (compelling reason to buy).
- Our product is different from (product alternatives).
- We have integrated (key whole product features suitable for your use).
